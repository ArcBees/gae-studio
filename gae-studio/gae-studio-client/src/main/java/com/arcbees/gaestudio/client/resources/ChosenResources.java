...
public interface ChosenResources extends Resources {
    ...
    @Override
    @Source({"com/arcbees/chosen/client/resources/colors.gss", "com/arcbees/chosen/client/resources/icons/icons.gss",
            "com/arcbees/gsss/mixin/client/mixins.gss", "com/arcbees/chosen/client/resources/chozen.gss",
            "css/chozen.gss"})
    CustomChosenCss css();
}
