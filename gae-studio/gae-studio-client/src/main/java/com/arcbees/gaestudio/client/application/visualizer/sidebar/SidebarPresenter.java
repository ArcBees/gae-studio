...
public class SidebarPresenter extends PresenterWidget<SidebarPresenter.MyView>
        implements SidebarUiHandlers, DeleteFromNamespaceHandler, EntitiesDeletedHandler,
        ImportCompletedEvent.ImportCompletedHandler, ValueChangeHandler<AppIdNamespaceDto> {
