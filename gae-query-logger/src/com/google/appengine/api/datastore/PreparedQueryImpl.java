...
class PreparedQueryImpl extends BasePreparedQuery {
  ...
  private QueryResultIteratorImpl runQuery(Query q, FetchOptions fetchOptions) {
    ...
    Future<QueryResult> result = DatastoreApiHelper.makeAsyncCall(
        apiConfig, "RunQuery", queryProto, new QueryResult());
    ...
    QueryResultsSourceImpl src = new QueryResultsSourceImpl(apiConfig, fetchOptions, txn, result);
